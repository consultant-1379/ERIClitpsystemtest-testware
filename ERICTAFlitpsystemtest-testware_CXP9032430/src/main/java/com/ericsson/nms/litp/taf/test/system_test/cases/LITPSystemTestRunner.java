package com.ericsson.nms.litp.taf.test.system_test.cases;
...
public class LITPSystemTestRunner extends TorTestCaseHelper {
    
    Logger logger = Logger.getLogger(LITPSystemTestRunner.class);
     ...
     * @PRIORITY HIGH
     */
    @TestId(id = "CXP9032430-1", title = "Run python test cases for Regression Suites")
    @Test(groups={"ACCEPTANCE", "CDB_REGRESSION"})
    public void runERIClitpSystemTests() {
     ...
     * @param failures
     */
    @TestId(id = "CXP9032430-2", title = "Parse xml outputs from python tests")
