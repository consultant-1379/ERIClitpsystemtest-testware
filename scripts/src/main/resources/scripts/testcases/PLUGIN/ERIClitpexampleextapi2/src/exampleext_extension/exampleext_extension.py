...
from litp.core.model_type import ItemType, Property, PropertyType, Child
        ...
        item_types.append(
            ...
            ItemType("example-item",
                     ...
                     name=Property("basic_string",
                                   ...
                                   required=True),
                     newname=Property("basic_string",
                                   prop_description="New name of item",
                                   required=True),
                     ...
                     restonly=Property("basic_string",
                                   ...
                                   updatable_plugin=False,
                                   updatable_rest=True),
                     child=Child('example-item-child'),
                     )
             )
        item_types.append(
            ItemType("example-item-child",
                     item_description="Example item child type",
                     name=Property("basic_string",
                                        required=True),
                     child=Child('example-lower-child'),
                    )
             )
        item_types.append(
            ItemType("example-lower-child",
                     item_description="Example item child type",
                     name=Property("basic_string",
                                        required=True),
                     updatable=Property("basic_string",
