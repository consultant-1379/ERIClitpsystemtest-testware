...
from extorderedtwo_plugin.extorderedtwo_plugin import ExtOrderedTwoPlugin
...
class TestExtOrderedTwoPlugin(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.plugin = ExtOrderedTwoPlugin()
