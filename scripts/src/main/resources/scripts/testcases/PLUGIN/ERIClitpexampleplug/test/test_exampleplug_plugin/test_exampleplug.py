...
from exampleplug_plugin.exampleplug_plugin import ExamplePlugPlugin
...
class TestExamplePlugPlugin(unittest.TestCase):
    ...
    def setup_model(self):
        ...
        self.node2 = self.model.create_item("node", "/node2",
                                                 hostname="special")
        self.se1 = self.model.create_item("example-item", "/software/items/ex",
                                              name="hello")
