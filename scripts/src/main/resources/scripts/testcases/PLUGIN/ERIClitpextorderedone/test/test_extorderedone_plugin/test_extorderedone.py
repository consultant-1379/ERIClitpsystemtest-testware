...
from extorderedone_plugin.extorderedone_plugin import ExtOrderedOnePlugin
...
class TestExtOrderedOnePlugin(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.plugin = ExtOrderedOnePlugin()
